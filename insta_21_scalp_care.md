...
Scene: The model runs his fingers through his silver-gray hair at a sleek bathroom mirror, examining his scalp with focused precision. Dark grooming products on the counter. The gesture is deliberate and diagnostic.
...
Lighting: Warm overhead bathroom light emphasizing hair texture and scalp area
...
Inside the frame: Two 40s male head silhouettes side by side — left silhouette labeled "ケア済み" with healthy hair lines radiating outward, right silhouette labeled "放置" with hair loss indication and wavy odor lines rising from the scalp. Simple monochrome comparison diagram.
...
頭皮は「見えない基盤」。崩れてから対策しても遅い。頭皮の状態は臭いと抜け毛という形で必ず顕在化する。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「見えない基盤」「崩れてから対策しても遅い」 → Noto Sans JP Bold 24px.
...
Title:
40代以降で皮脂分泌が乱れ、頭皮環境が急変する。
Font: Noto Sans JP Black, 54px, black (#000000), centered.

White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: A flow diagram showing: 皮脂過剰 → 毛穴詰まり → 炎症 → 抜け毛, with simple arrows connecting each stage. Each stage shown as a small icon — oil droplet, clogged pore, inflammation mark, falling hair strand.
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
テストステロンの影響で皮脂分泌が増加し、毛穴を詰まらせる。放置すると毛包が弱体化し、髪の密度が落ちる。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「毛穴を詰まらせる」「毛包が弱体化」 → Noto Sans JP Bold 24px.
...
Title:
解決策①：頭皮専用シャンプーで皮脂をリセットする
Font: Noto Sans JP Black, 54px, black (#000000), centered.

White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: Step-by-step shampooing illustration — a 40s male's hands showing finger pads (not nails) massaging a scalp with small circular motion arrows, a timer icon showing 60 seconds for rinsing, and a crossed-out fingernail icon indicating "no scratching."
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
アミノ酸系シャンプーで頭皮の皮脂を適切に除去。ゴシゴシ洗いは頭皮を傷め逆効果。指の腹で丁寧に、すすぎは60秒以上。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「アミノ酸系シャンプー」「指の腹で・すすぎ60秒以上」 → Noto Sans JP Bold 24px.
...
Title:
解決策②：頭皮マッサージで血流と毛根を活性化する
Font: Noto Sans JP Black, 54px, black (#000000), centered.

White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: Top-down view of a head outline showing three massage zones marked with circles and labels — 側頭部 (both sides), 頭頂部 (top center), 後頭部 (back). Fingertip pressure icons at each zone with small circular motion arrows.
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
入浴中1分の頭皮マッサージで毛根への血流が増加する。育毛剤との併用でさらに効果が高まる。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「入浴中1分」「毛根への血流が増加」 → Noto Sans JP Bold 24px.
...
Title:
解決策③：食事・睡眠・ストレス管理が頭皮を守る
Font: Noto Sans JP Black, 54px, black (#000000), centered.

White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: Four-quadrant diagram showing the relationship between scalp health and lifestyle factors — タンパク質 (protein icon: meat/fish), 亜鉛 (zinc icon: supplement capsule), 睡眠 (sleep icon: moon/zzz), ストレス (stress icon: person with tension lines), each with a simple connecting arrow pointing to a healthy hair strand in the center.
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
髪の主成分はタンパク質と亜鉛。食事を整え睡眠を確保することで、頭皮環境は内側から改善される。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「タンパク質と亜鉛」「内側から改善」 → Noto Sans JP Bold 24px.
...
薄毛・頭皮の臭い——これらは「清潔感の土台」が崩れたサインだ。40代以降は皮脂分泌の乱れが加速し、放置すると毛包が弱体化する。

✔ アミノ酸系シャンプー＋指の腹で丁寧に洗う
✔ 入浴中1分の頭皮マッサージで血流活性化
✔ タンパク質・亜鉛の食事管理
...
#頭皮マッサージ #育毛 #40代スキンケア #ビジネスパーソン #BELDANTE
