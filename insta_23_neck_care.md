# 40代からの「首ケア」——年齢という最もリークしやすい機密情報を守れ
...
Scene: The model adjusts his collar and applies product to his neck in a bathroom mirror — fingertips pressing gently along the jawline and neck with upward strokes. Deliberate, ritual-like motion.
...
Lighting: Side lighting emphasizing neck texture and jawline definition
...
Inside the frame: Side-by-side comparison of a 40s male — left side showing a well-groomed face with smooth skin, right side showing the same face but with wrinkled, dull neck/decollete area. A contrast bracket highlighting the mismatch between face and neck.
...
顔のスキンケアを徹底しても、首が乾燥・シワだらけでは年齢がリークする。首は「スキンケアの盲点」として最も老化が露出しやすい部位だ。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「スキンケアの盲点」「老化が露出しやすい」 → Noto Sans JP Bold 24px.
...
Title:
首は紫外線・重力・スマホ首の三重苦にさらされている
Font: Noto Sans JP Black, 54px, black (#000000), centered.

White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: Three-panel diagram showing the three causes — Left: UV rays icon (sun with arrows) hitting the neck labeled 「UV」, Center: gravity arrow pulling neck skin downward labeled 「重力による下垂」, Right: a 40s male silhouette in forward-head posture looking at phone labeled 「スマホ首」.
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
首は顔と同量のUVダメージを受けながら、スキンケアをほぼ受けない部位。スマホ首による慢性的な前傾がシワを刻み込む。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「顔と同量のUVダメージ」「スマホ首がシワを刻む」 → Noto Sans JP Bold 24px.
...
Title:
解決策①：顔のスキンケアを首・デコルテまで延長する
Font: Noto Sans JP Black, 54px, black (#000000), centered.

White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: A 40s male silhouette showing application technique — upward stroke arrows going from chest/decollete up to chin along the neck. A crossed-out downward arrow with X mark beside it showing the wrong direction. Labels: 「下から上へ」 (correct) vs 「上から下」(wrong).
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
化粧水・保湿剤・日焼け止めを首まで毎日塗布する。塗布方向は必ず「下から上」。上から塗ると重力方向に引っ張り逆効果になる。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「下から上へ」「毎日首まで延長する」 → Noto Sans JP Bold 24px.
...
White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: Illustration of a cream jar labeled with ingredient icons (molecular structure sketches for retinol and peptide), plus a 40s male applying cream to his neck with upward massage strokes, and a moon icon indicating nighttime application.
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
レチノール・ペプチド配合の首用クリームは、コラーゲン産生を促進し縦ジワを改善する。就寝前の集中ケアが最も効果的だ。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「レチノール・ペプチド配合」「就寝前の集中ケア」 → Noto Sans JP Bold 24px.
...
Title:
解決策③：スマホ首の姿勢改善で新しいシワを防ぐ
Font: Noto Sans JP Black, 54px, black (#000000), centered.

White illustration frame:
Centered white rectangle, wide and horizontal, white fill (#FFFFFF), no border radius.
Inside the frame: Two-part illustration — Left: a 40s male raising a smartphone to eye level with a checkmark. Right: chin-tuck exercise shown in profile view (chin pulled back, neutral spine posture) with a timer icon showing 10 seconds × 3 reps.
Style: simple monochrome line art, hand-drawn feel, black outlines only on white, no gray fill.

Body text (below illustration frame, centered, line-height 1.7):
スマホを目線の高さに上げる。1時間ごとに顎引き運動（10秒×3回）でスマホ首をリセット。新しいシワを刻まないことが最大のケアだ。
Font: Noto Sans JP Regular 22px for standard text.
Emphasized words: 「スマホを目線の高さに」「顎引き運動」 → Noto Sans JP Bold 24px.
...
首は顔と同量のUVダメージを受けながら、スキンケアをほぼ受けない「盲点部位」だ。スマホ首のシワ×乾燥×UV——三重苦を放置すると取り返しがつかない。

✔ スキンケアの最後に首・デコルテまで延長（下から上向き）
✔ 就寝前に首用クリーム（レチノール・ペプチド配合）
✔ スマホを目線の高さに上げる習慣
...
#スキンケア男子 #ネックケア #40代スキンケア #ビジネスパーソン #BELDANTE
